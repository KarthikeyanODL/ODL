 ...
 */
package org.opendaylight.test.cli.commands;
...
public class TestCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TestCliTestCommand.class);
    protected final TestCliCommands service;

    public TestCliTestCommand(final TestCliCommands service) {
